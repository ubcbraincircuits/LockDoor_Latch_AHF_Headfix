...
class AHF_HeadFixer(AHF_Base, metaclass= ABCMeta):
    ...
    def releaseMouse(self, thisTag, resultsDict = {}, settingsDict = {}):
        ...
        setAngle(0) #added line of code to move second servo back to initial position and unlock the door
    ...
    def hardwareTest(self):
        ...
        print('Door Lock door-locking for 2 sec')
        self.fixMouse(0, {},{})
        sleep(2)
        self.releaseMouse(0, {},{})
        inputStr=input('Door unlocked.\nDo you want to change the Door-Lock settings?')
